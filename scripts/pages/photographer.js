...
class PhotographerMedia {
    ...
    async generateMedia() {
        ...
        const { articleMedias, numberLikes } = this.mediasTemplate();
        ...
        const filterMedias = document.getElementById("filter_medias");
        filterMedias.addEventListener('input', () => this.filterMediaby(filterMedias.value));
    ...
    filterMediaby(inputValue) {
        let filterMedias = this.allMedias;
        ...
        const mediaByName = filterMedias.sort(this.filtertBy(`${inputValue}`));
        let { articleMedias, numberLikes } = this.mediasTemplate(mediaByName);
        document.querySelector('.photograph-medias').innerHTML = articleMedias.join('');
        let allLikes = document.querySelector(".numberLikes");
        allLikes.innerHTML = numberLikes;

        const popupFactory = new PopupFactory(this.photographerName, mediaByName);
